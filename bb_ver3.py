...
class BB_ver3:
    ...
    def prouning(self, model, idx, isfraction):
        ...
        self.cnt_node += 1
        heapq.heappush(self.pq, (self.objVal, 0.5-(isfraction%1), self.cnt_node, upper_model, self.sol))
        self.cnt_node += 1
        heapq.heappush(self.pq, (self.objVal, 0.5-(isfraction%1), self.cnt_node, lower_model, self.sol))
